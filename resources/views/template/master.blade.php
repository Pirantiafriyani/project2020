						...
						<li class="nav-item active">
							...
							<div class="collapse" id="dashboard">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="https://themekita.com/demo-millenium-bootstrap/millenium/examples/demo2/index.html">
											<span class="sub-item">Dashboard 2</span>
										</a>
									</li>
									<li>
										<a href="https://themekita.com/demo-millenium-bootstrap/millenium/examples/demo3/index.html">
											<span class="sub-item">Dashboard 3</span>
										</a>
									</li>
									<li>
										<a href="https://themekita.com/demo-millenium-bootstrap/millenium/examples/demo4/index.html">
											<span class="sub-item">Dashboard 4</span>
										</a>
									</li>
									<li>
										<a href="https://themekita.com/demo-millenium-bootstrap/millenium/examples/demo5/index.html">
											<span class="sub-item">Dashboard 5</span>
										</a>
									</li>
									<li>
										<a href="https://themekita.com/demo-millenium-bootstrap/millenium/examples/demo6/index.html">
											<span class="sub-item">Dashboard 6</span>
										</a>
									</li>
									<li>
										<a href="https://themekita.com/demo-millenium-bootstrap/millenium/examples/demo7/index.html">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="https://themekita.com/demo-millenium-bootstrap/millenium/examples/assets/img/logoproduct.svg" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="https://themekita.com/demo-millenium-bootstrap/millenium/examples/assets/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="template/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
								...
								<div class="quick-scroll scrollbar-outer">
									<div class="quick-content contact-content">
										...
										<div class="avatar-group">
											<div class="avatar">
												<img src="template/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="template/assets/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="template/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="template/assets/img/talha.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
